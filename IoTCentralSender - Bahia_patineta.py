...
device_id = "203s785mx14"
scope_id = "0ne00FF42CF"
key = "/BD8XnAgkCO4HZnnhNi/0frzm5tCawuk0Mh8f3VpnNQ="
    ...
    while not client.terminated():
        if client.is_connected():
            await client.send_telemetry(
                {
                    "Ocupacion": random.choice(bool),
                    "Seguro_mecanico": random.choice(bool),
                    "Nivel_bateria": random.randint(0, 100),
                    "Corriente_carga": random.randint(0, 5)
                },
